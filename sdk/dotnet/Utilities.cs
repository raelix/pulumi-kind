...
namespace Pulumi.Kind
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Kind.version.txt");
    ...
    internal sealed class KindResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KindResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

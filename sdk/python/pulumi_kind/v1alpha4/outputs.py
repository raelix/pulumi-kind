...
__all__ = [
    'KindClusterKindConfig',
    'KindClusterKindConfigNetworking',
    'KindClusterKindConfigNode',
    'KindClusterKindConfigNodeExtraMount',
    'KindClusterKindConfigNodeExtraPortMapping',
]

@pulumi.output_type
class KindClusterKindConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KindClusterKindConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KindClusterKindConfig.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 networking: Optional['outputs.KindClusterKindConfigNetworking'] = None,
                 nodes: Optional[Sequence['outputs.KindClusterKindConfigNode']] = None):
    ...
    @property
    @pulumi.getter
    def networking(self) -> Optional['outputs.KindClusterKindConfigNetworking']:
        return pulumi.get(self, "networking")

    @property
    @pulumi.getter
    def nodes(self) -> Optional[Sequence['outputs.KindClusterKindConfigNode']]:
        return pulumi.get(self, "nodes")


@pulumi.output_type
class KindClusterKindConfigNetworking(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KindClusterKindConfigNetworking. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KindClusterKindConfigNetworking.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class KindClusterKindConfigNode(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "extraMounts":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KindClusterKindConfigNode. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KindClusterKindConfigNode.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 extra_mounts: Optional[Sequence['outputs.KindClusterKindConfigNodeExtraMount']] = None,
                 extra_port_mappings: Optional[Sequence['outputs.KindClusterKindConfigNodeExtraPortMapping']] = None,
    ...
    def extra_mounts(self) -> Optional[Sequence['outputs.KindClusterKindConfigNodeExtraMount']]:
        return pulumi.get(self, "extra_mounts")

    @property
    @pulumi.getter(name="extraPortMappings")
    def extra_port_mappings(self) -> Optional[Sequence['outputs.KindClusterKindConfigNodeExtraPortMapping']]:
...
@pulumi.output_type
class KindClusterKindConfigNodeExtraMount(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KindClusterKindConfigNodeExtraMount. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KindClusterKindConfigNodeExtraMount.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class KindClusterKindConfigNodeExtraPortMapping(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in KindClusterKindConfigNodeExtraPortMapping. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        KindClusterKindConfigNodeExtraPortMapping.__key_warning(key)
        return super().__getitem__(key)

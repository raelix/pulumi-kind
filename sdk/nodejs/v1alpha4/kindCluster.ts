...
export class KindCluster extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KindClusterState, opts?: pulumi.CustomResourceOptions): KindCluster {
        return new KindCluster(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is KindCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KindCluster.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: KindClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KindClusterArgs | KindClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KindClusterState | undefined;
            ...
            const args = argsOrState as KindClusterArgs | undefined;
        ...
        super(KindCluster.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface KindClusterState {
    /**
     * Client certificate for authenticating to cluster.
     */

...
func NewKindCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kind:v1alpha4/kindCluster:KindCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKindCluster(ctx *pulumi.Context,
	...
	var resource KindCluster
	err := ctx.ReadResource("kind:v1alpha4/kindCluster:KindCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

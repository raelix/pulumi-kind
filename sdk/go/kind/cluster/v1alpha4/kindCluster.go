...
import (
	...
	"github.com/pulumi/pulumi-kind/sdk/go/kind/cluster"
...
type KindCluster struct {
	...
	KindConfig cluster.KindClusterKindConfigPtrOutput `pulumi:"kindConfig"`
...
func NewKindCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kind:cluster/v1alpha4/kindCluster:KindCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKindCluster(ctx *pulumi.Context,
	...
	var resource KindCluster
	err := ctx.ReadResource("kind:cluster/v1alpha4/kindCluster:KindCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type kindClusterState struct {
	...
	// The kind_config that kind will use to bootstrap the cluster.
	KindConfig *cluster.KindClusterKindConfig `pulumi:"kindConfig"`
	// Kubeconfig set after the the cluster is created.
...
type KindClusterState struct {
	...
	// The kind_config that kind will use to bootstrap the cluster.
	KindConfig cluster.KindClusterKindConfigPtrInput
	// Kubeconfig set after the the cluster is created.
...
// The kind_config that kind will use to bootstrap the cluster.
func (o KindClusterOutput) KindConfig() cluster.KindClusterKindConfigPtrOutput {
	return o.ApplyT(func(v *KindCluster) cluster.KindClusterKindConfigPtrOutput { return v.KindConfig }).(cluster.KindClusterKindConfigPtrOutput)
}
